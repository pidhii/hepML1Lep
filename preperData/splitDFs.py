...
class splitDFs(object):
    def __init__(self,signalDF, bkgDF,do_binary_first = False,do_multiClass = True,nSignal_Cla = 1,do_parametric = True,split_Sign_training = False):
